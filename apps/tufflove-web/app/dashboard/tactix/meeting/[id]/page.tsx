  ...
  if (error || !meeting) {
    return (
      <div style={{ padding: "40px", textAlign: "center", fontFamily: "sans-serif" }}>
        ...
        <Link href="/dashboard/tactix" style={{ color: "blue" }}>← Back to Pitch Engine</Link>
      </div>
    );
  }
  ...
  return (
    <div style={{ fontFamily: "sans-serif", maxWidth: "900px", margin: "0 auto", paddingBottom: "50px", color: "#333" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <Link href="/dashboard/tactix" style={{ color: "gray", textDecoration: "none", fontSize: "12px" }}>← Back to Pitch Engine</Link>
